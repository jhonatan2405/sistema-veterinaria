...
<div class="login-box">
  <div class="login-logo">
    <a href="<?php echo $URL;?>/public/templeates/AdminLTE-3.2.0/index2.html"><b>Sistema De Ingreso</b></a>
  </div>
  <!-- /.login-logo -->
  <div class="card">
    <div class="card-body login-card-body">
        <img src="<?php echo $URL;?>/public/img/logo%20sin%20fondo.png" width="95%" alt="">
        <br><br>
